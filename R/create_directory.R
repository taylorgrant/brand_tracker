create_directory <- function(brand, filters, main_subfolders = c("tables", "figures", "competitive", "mental_advantage", "raw_data"), subfolders = c("Campaign", "Social", "Digital", "TV")) {
